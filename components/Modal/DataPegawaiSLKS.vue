...
const riwayat = reactive<riwayat[]>([
  {
    nama: 'Satyalancana Karya Satya 20 Tahun',
    nomor: '15793/4/2012',
    tanggal: '10 Mei 2023',
  },
  {
...
<template>
  <ModalBaseDetail :is-open="show" :title="title" @close="closeModal">
    <div class="">
      <nav class="flex flex-col sm:flex-row">
        ...
        <button :class="[
          ...
          {
            'text-green-600 border-b-2 border-green-600': selectedComponent === 'riwayat',
          },
        ]" @click="showComponent('riwayat'); resetNilai();">
          Riwayat Penghargaan
        </button>
      </nav>
    </div>
    ...
    <div v-if="selectedComponent === 'riwayat'">
      <table
          class="w-full text-sm text-left text-gray-800 border rounded-lg border-separate border-spacing-0 mt-5"
        ...
        >
          ...
          >
            <tr class="[&>*]:border-b">
              ...
              <th scope="col" class="px-2 py-2.5">Nama Penghargaan</th>
              <th scope="col" class="px-2 py-2.5">Nomor SK</th>
              <th scope="col" class="px-2 py-2.5">Tanggal SK</th>
              <th scope="col" class="px-2 py-2.5 rounded-tr-lg">Berkas</th>
            </tr>
          </thead>
          <tbody class="[&>*:nth-child(even)]:bg-gray-50">
            ...
            >
              ...
              <td class="px-2 py-2.5">{{ item.nomor }}</td>
              <td class="px-2 py-2.5">{{ item.tanggal }}</td>
              <td class="px-2 py-2.5 rounded-tr-lg">
                <a href="#" class="text-sm text-blue-600 font-bold underline"
                  > Unduh Berkas</a
                >
              </td>
            </tr>
