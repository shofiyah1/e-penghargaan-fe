...
const selectedComponentData = computed(() => {
  if (selectedComponent.value === 'usulan') {
    return {
      title: 'Usulan Pembekalan',
      description: 'Data usulan pembekalan aparatur sipil negara Pemerintah Provinsi Jawa barat',
    };
  } else if (selectedComponent.value === 'hukdis') {
    return {
      title: 'Hukdis / CLTN',
      description: 'Data hukdis / CLTN usulan pembekalan aparatur sipil negara Pemerintah Provinsi Jawa barat',
    };
  } else if (selectedComponent.value === 'persyaratan') {
    return {
      title: 'Persyaratan',
      description: 'Persyaratan usulan pembekalan aparatur sipil negara Pemerintah Provinsi Jawa barat',
    };
  }
});
      ...
      <div class="mt-5 flex flex-col gap-4">
          <div class="flex items-center">
            <label class="flex items-center">
               <input
                  type="checkbox"
                  class="form-checkbox h-5 w-5 text-green-500 ml-2"
          ...
          >
            ...
            >
              <tr class="[&>*]:border-b">
                ...
                <th scope="col" class="px-2 py-2.5 whitespace-nowrap">
                  Perangkat Daerah
                </th>
                <th scope="col" class="px-2 py-2.5 whitespace-nowrap">Jabatan</th>
            ...
            <ModalDataPegawai
              v-if="modalIndex !== -1"
              :show="showDataPegawaiModal"
              :title="modalTitle" 
              @close="showDataPegawaiModal = false"
            />
          </table>
          <Pagination
          ...
          >
            ...
            >
              <tr class="[&>*]:border-b">
                ...
                <th scope="col" class="px-2 py-2.5 whitespace-nowrap">No SK CLTN</th>
            ...
            <tbody class="[&>*:nth-child(even)]:bg-gray-50">
              ...
              >
                ...
                <td class="px-2 py-2.5">
                  ...
                  <button 
                    @click="openRiwayatStatusModal(i)"
                    class="text-sm text-blue-600 font-bold underline"
                  >
          ...
          >
            ...
            <tbody class="[&>*:nth-child(even)]:bg-gray-50">
              ...
              >
                ...
                <td class="px-2 py-2.5">
                  <button
                   @click="openPengusulanLoyalitasModal(i)"
                    class="text-sm text-blue-600 font-bold underline"
                  >
            ...
            <ModalPengusulanLoyalitas
              v-if="modalIndex !== -1"
              :show="showPengusulanLoyalitasModal"
              :title="modalTitle" 
              @close="showPengusulanLoyalitasModal = false"
            />
            <ModalRiwayatStatus :show="showRiwayatStatusModal" :title="modalTitle" @close="closeModal" :data="pendaftar[modalIndex]" />
          </table>
          <Pagination
